<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchPage.aspx.cs" Inherits="QuadaceGamestore.SearchPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:80vh;">
        ...
        <br /><br />       
        <div style="justify-content:center; align-items:center; display:flex; flex-direction:column;" class="text-center">
            <h3>Buy</h3><br />
            <asp:DataList ID="DataList1" runat="server" style="padding-left:100px;" Font-Size="Small" RepeatColumns="5" RepeatDirection="Horizontal" Width="1200px" OnItemCommand="DataList1_ItemCommand1" >
                <ItemStyle ForeColor="Black"/>
                <ItemTemplate>
                            <div style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                                <div style="height:20px;"></div>
                                <div class="titles">
                                    <asp:Label ID="Label3" style="padding-bottom:10px;" runat="server" Text='<%# Bind("productbuy_name") %>'></asp:Label>
                                </div>
                                <div>
            ...
            <asp:DataList ID="DataList2" runat="server"  Font-Size="Small" RepeatColumns="5" RepeatDirection="Horizontal" Width="1200px" OnItemCommand="DataList2_ItemCommand1" >
                <ItemStyle ForeColor="Black"/>
                <ItemTemplate>
                            <div style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                                <div style="height:20px;"></div>
                                <div class="titles">
                                    <asp:Label ID="Label3" style="padding-bottom:10px;" runat="server" Text='<%# Bind("productrent_name") %>'></asp:Label>
                                </div>
                                <div>
                                    <asp:Image ID="imgPhoto" runat="server" Width="100px" Height="125px" ImageUrl='<%#"~/Images/"+Eval("productrent_image").ToString() %>'  />
                                </div>
                                <div class="price">
                                    RM<asp:Label ID="Label2" runat="server" Text='<%# Bind("productrent_price", "{0:n}") %>'></asp:Label>/day
                                </div>
                                <br />
                                <asp:Button ID="DetailsClick" CssClass="button_details" runat="server" Text="Details" CommandArgument='<%# Eval("productrent_id") %>' CommandName="ViewDetails" />
                                <div style="height:20px;"></div>
                        </div>
                </ItemTemplate>
            </asp:DataList>
