<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeliveryCompleted.aspx.cs" Inherits="QuadaceGamestore.DeliveryMan.DeliveryCompleted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-left:10%; margin-right:10%; margin-top:1%;padding:5px 16px;height:200px;">
        <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                <asp:Button ID="btn_shipping" CssClass="btn_cat" runat="server" Text="Shipping" OnClick="Ship_Click"/>
