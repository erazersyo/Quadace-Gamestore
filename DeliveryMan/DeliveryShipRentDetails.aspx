<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeliveryShipRentDetails.aspx.cs" Inherits="QuadaceGamestore.DeliveryMan.DeliveryShipRentDetails" %>
        ...
        <div style="width:83%; font-family:Arial; font-size:20px;">
            ...
            <div class="center-blank">
                <div class="left-images">
                    <asp:Label ID="Label6" style="font-family:Arial;" runat="server" Text="Update your delivery status here : "></asp:Label><br />
                    <asp:TextBox ID="txtbox_status" runat="server" class="txtboxship" TextMode="Multiline"></asp:TextBox><br />
                    <asp:Button runat="server" class="button-update" Text="UPDATE" OnClick="UpdateStatus_Click" /><br /><br /><br />
                    <asp:FileUpload ID="imageAdd" style="font-size:16px;" runat="server"></asp:FileUpload><br /><br />
                    <asp:Button runat="server" class="button-update" Text="ORDER DELIVERED" OnClick="OrderDelivered_Click" />
                 </div>
