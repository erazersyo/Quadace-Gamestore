<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageOrderCompleted.aspx.cs" Inherits="QuadaceGamestore.Admin.ManageOrderCompleted" %>
        ...
        <ul class="list">
          ...
          <li class="dropbtneds"><a href="#" class="active" >Manage Order <i class="fa fa-angle-down" style="padding-left:73px;"></i></a></li>
            <div class="dropdown-contenteds">
                <a class="activesed" href="ManageOrder.aspx">Buy</a>
        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
          <h2>Order List For Buy</h2>
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_completed" CssClass="btn_cats" runat="server" Text="Completed"  />
