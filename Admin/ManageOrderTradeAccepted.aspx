<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageOrderTradeAccepted.aspx.cs" Inherits="QuadaceGamestore.Admin.ManageOrderTradeAccepted" %>
        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
          <h2>Request List For Trade</h2>
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_shipping" CssClass="btn_cats" runat="server" Text="Accepted" OnClick="Accepted"/>
                        ...
                        <div class ="lefted">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>RM <asp:Label ID="Label11" runat="server" Text='<%# Bind("trade_price", "{0:n}") %>'></asp:Label></td>
                                </tr>
                            </table>
                        </div>
                        <div class="righted">
