<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderDetailsProductRent.aspx.cs" Inherits="QuadaceGamestore.Admin.OrderDetailsProductRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="margin-left:20%;padding:1px 16px;height:200px;">
        <h2>Order Details</h2>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QuadaceGamestoreConnectionString %>" SelectCommand="SELECT * FROM [OrderRent] WHERE ([orderrent_id] = @orderrent_id)">
            ...
            <div style="width:83%; font-family:Arial; font-size:20px;">
                <asp:Label ID="lbl_tracking" Runat="server" Visible="false"></asp:Label>
                <asp:Button ID="Button1" class="button-ship" runat="server" Text="Ship" OnClick="Ship_Click"/>
                </div>
            </div>
</asp:Content>
