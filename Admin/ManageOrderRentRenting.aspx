<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageOrderRentRenting.aspx.cs" Inherits="QuadaceGamestore.Admin.ManageOrderRentRenting" %>
        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
          <h2>Order List For Rent</h2>
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_completed" CssClass="btn_cats" runat="server" Text="Renting" OnClick="Renting" />
