<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderDetailsProductRentRenting.aspx.cs" Inherits="QuadaceGamestore.Admin.OrderDetailsProductRentRenting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataGrid ID="dgTracking" CssClass="datagrid" runat="server" AutoGenerateColumns="False" Width="500px">
        ...
        <div style="width:83%; font-family:Arial; font-size:20px;">
            <asp:Button ID="Button1" class="button-ships" runat="server" Text="Order Completed" OnClick="Returned_Click"/>
        </div>
   </div>
    </div>
</asp:Content>
