<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageOrderTrade.aspx.cs" Inherits="QuadaceGamestore.Admin.ManageOrderTrade" %>
                    ...
                    <div class="centered">
                        <div class ="lefted">
                            <table>
                                ...
                                <tr>
                                    <td><asp:Label ID="Label8" style="font-weight:bold;" runat="server" Text="Price: "></asp:Label></td>
                                    <td>RM <asp:TextBox ID="txt_price" style="width:100px; font-size:16px;" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr style="height:200px;">
                                    <td><asp:Button ID="AcceptClick" CssClass="button-accept" runat="server" Text="Accept" OnClick="AcceptedButton"/></td>
                                    <td><asp:Button ID="Button1" CssClass="button-decline" runat="server" Text="Decline" OnClick="DeclinedButton"/></td>
                                </tr>
                            </table>
