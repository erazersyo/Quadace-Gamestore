<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageProductRent.aspx.cs" Inherits="QuadaceGamestore.Admin.ManageProductRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
          <h2>Manage Product</h2>
            <div class="dropdown">
                <button class="dropbtn">Rent    <i class="fa fa-angle-down"></i></button>
                    <div class="dropdown-content">
                        <a href="ManageProduct.aspx">Buy</a>
                        <a href="ManageProductRent.aspx">Rent</a>
                        <a href="GenerateReport.aspx">Trade</a>
                    </div>
			 </div>
            <br /><br />
            ...
            <asp:DataGrid ID="dgProductBuy" CssClass="datagrid" runat="server" AllowPaging="True" AutoGenerateColumns="false" OnCancelCommand="dgCancel_ProductBuy" OnEditCommand="dgEdit_ProductBuy" OnItemCommand="dgProductBuy_ItemCommand" OnItemDataBound="dgProductBuy_ItemDataBound" OnPageIndexChanged="dgProductBuy_PageIndexChanged" OnUpdateCommand="dgUpdate_ProductBuy" PageSize="10" ShowFooter="true" Width="1150px" CellPadding="10" CellSpacing="30" Height="80px">
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="Product ID">
                            <ItemTemplate>
                                <asp:Label ID="IDProductBuy" Runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_id") %>'></asp:Label>
                        ...
                        <asp:TemplateColumn HeaderText="Product Name">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txt_ProductBuy_Name" runat="server" MaxLength="50" class="update_textbox" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_name") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemStyle Width="35%" />
                            <HeaderStyle Font-Bold="True"/>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Product Price /day">
                            <ItemTemplate>
                                <asp:Label ID="lbl_ProductBuy_Price" Runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_price", "{0:n}") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txt_ProductBuy_Price" runat="server" MaxLength="50" class="update_textbox" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_price", "{0:n}") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemStyle Width="15%" />
                            <HeaderStyle Font-Bold="True" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Product Quantity">
                            <ItemTemplate>
                                <asp:Label ID="lbl_ProductBuy_Quantity" Runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_quantity") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txt_ProductBuy_Quantity" runat="server" MaxLength="50" class="update_textbox" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_quantity") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemStyle Width="8%" />
                            <HeaderStyle Font-Bold="True" />
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Product Description">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txt_ProductBuy_Description" runat="server" TextMode="MultiLine" class="update_textbox" Text='<%# DataBinder.Eval(Container.DataItem, "productrent_description") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemStyle Width="20%" />
                            <HeaderStyle Font-Bold="True" />
                        </asp:TemplateColumn>
