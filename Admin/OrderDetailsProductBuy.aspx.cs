...
{
    public partial class OrderDetailsProductBuy : System.Web.UI.Page
    {
        ...
        protected void Ship_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("UPDATE OrderBuy SET orderbuy_status = 'shipping', orderbuy_tracking = '" + lbl_tracking.Text+ "' WHERE orderbuy_id = '" + orderid.Text +"'", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            ...
            SqlCommand cmd1 = new SqlCommand("INSERT INTO OrderBuyTracking VALUES ('" +lbl_tracking.Text +"', 'Seller is preparing to ship your parcel' , getdate())", con1);
            con1.Open();
