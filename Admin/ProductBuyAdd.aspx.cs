...
{
    public partial class ProductBuyAdd : System.Web.UI.Page
    {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            if (Path.GetExtension(imageAdd.PostedFile.FileName) == ".jpg" || Path.GetExtension(imageAdd.PostedFile.FileName) == ".jpeg" || Path.GetExtension(imageAdd.PostedFile.FileName) == ".png" || Path.GetExtension(imageAdd.PostedFile.FileName) == ".bmp")
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO ProductBuy VALUES ('" + fileName + "','" + nameAdd.Text + "','" + categoryAdd.Text + "','" + priceAdd.Text + "','" + quantityAdd.Text + "','" + descriptionAdd.Text + "')", con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
