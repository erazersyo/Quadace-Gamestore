...
{
    public partial class ManageOrderTradeDeclined : System.Web.UI.Page
    {
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM Trade WHERE trade_status='declined'", con);
