<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductRentAdd.aspx.cs" Inherits="QuadaceGamestore.Admin.ProductRentAdd" %>
        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
          <h1>Add Product for Rent</h1>
            <table class="tables">
                ...
                <tr>
                    <td style="width:100px;"><p>Price /day:</p></td>
