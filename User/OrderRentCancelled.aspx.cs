...
{
    public partial class OrderRentCancelled : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        public void SetupOrderBuy()
        {
            ...
            DataSet ds = orderbuy.GetOrderRentCancelledUserList(userid);
        ...
        protected void dgOrderBuy_ItemCommand(object sender, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "CancelOrderBuy")
            {
                ...
                {
                    Server.Transfer("OrderRentCancelled.aspx");
                }
            }
            ...
            if (e.CommandName == "OrderBuyDetails")
            {
                ...
                Response.Redirect("OrderRentDetailsCancelled.aspx?id=" + e.CommandArgument.ToString());
            }
        }
