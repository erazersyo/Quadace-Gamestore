<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderRentShipping.aspx.cs" Inherits="QuadaceGamestore.User.OrderRentShipping" %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_shipping" CssClass="btn_cateds" runat="server" Text="Shipping" OnClick="Shipping"/>
