<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderTradeRequest.aspx.cs" Inherits="QuadaceGamestore.User.OrderTradeRequest" %>
                        ...
                        <div class ="lefted">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="Label8" runat="server" Text="Pending"></asp:Label></td>
                                </tr>
                            </table>
