<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="QuadaceGamestore.User.Checkout" %>
    ...
    <div style="justify-content:center; display:flex; flex-direction:row;">
        <div class="center-blank">
            ...
            <div class="right-checkout">
                ...
                <h3>YOUR ORDER</h3>
                <asp:DataGrid ID="dgCheckout" CssClass="datagridc" runat="server" AutoGenerateColumns="False" Width="400px">
                    <AlternatingItemStyle CssClass="Even_Row_Checkout" />
                    <HeaderStyle CssClass="Table_Header_Checkout" />
                    <Columns>
                        <asp:TemplateColumn HeaderText="Product">
                        <ItemTemplate>
                            <asp:Label ID="lbl_pdid" Runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "productbuy_id") %>'></asp:Label>
                            <asp:Label ID="lbl_Name" Runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "productbuy_name") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="25%"/>
