...
{
    public partial class OrderRentReturned : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        public void SetupOrderBuy()
        {
            ...
            DataSet ds = orderbuy.GetOrderRentReturnedUserList(userid);
        ...
        protected void dgOrderBuy_ItemCommand(object sender, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "CancelOrderBuy")
            {
                ...
                {
                    Server.Transfer("OrderRentReturned.aspx");
                }
            }
