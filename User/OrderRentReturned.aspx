<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderRentReturned.aspx.cs" Inherits="QuadaceGamestore.User.OrderRentReturned" %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_returned" CssClass="btn_cateds" runat="server" Text="Returned" OnClick="Returned" />
