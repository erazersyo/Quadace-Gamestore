<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderRentCancelled.aspx.cs" Inherits="QuadaceGamestore.User.OrderRentCancelled" %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                <asp:Button ID="btn_toship" CssClass="btn_cated" runat="server" Text="To Ship" OnClick="ToShip"/>
                ...
                <asp:Button ID="btn_cancelled" CssClass="btn_cateds" runat="server" Text="Cancelled" OnClick="Cancelled" />
            </div>
