...
{
    public partial class OrderTradeRequest : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM Trade WHERE trade_status='pending' AND user_id='"+ Session["user_id"] +"'", con);
