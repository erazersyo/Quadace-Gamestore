<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderRentRenting.aspx.cs" Inherits="QuadaceGamestore.User.OrderRentRenting" %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                ...
                <asp:Button ID="btn_renting" CssClass="btn_cateds" runat="server" Text="Renting" OnClick="Renting" />
