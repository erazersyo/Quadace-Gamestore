<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderRentToShip.aspx.cs" Inherits="QuadaceGamestore.User.OrderRentToShip" %>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="height:5vh; text-align:center; display:flex; flex-direction:row;">
                <asp:Button ID="btn_toship" CssClass="btn_cateds" runat="server" Text="To Ship" OnClick="ToShip"/>
                <asp:Button ID="btn_shipping" CssClass="btn_cated" runat="server" Text="Shipping" OnClick="Shipping"/>
                <asp:Button ID="btn_renting" CssClass="btn_cated" runat="server" Text="Renting" OnClick="Renting" />
                <asp:Button ID="btn_returned" CssClass="btn_cated" runat="server" Text="Returned" OnClick="Returned" />
                <asp:Button ID="btn_cancelled" CssClass="btn_cated" runat="server" Text="Cancelled" OnClick="Cancelled" />
            </div>
            <asp:DataGrid ID="dgOrderBuy" CssClass="datagrid" runat="server" AutoGenerateColumns="false"  OnItemCommand="dgOrderBuy_ItemCommand" OnItemDataBound="dgOrderBuy_ItemDataBound"  Width="1000px" CellPadding="10" CellSpacing="30" Height="80px">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Details">
                            <HeaderStyle Font-Bold="True" />
                            <ItemTemplate>
                                <asp:Button ID="btnOrderBuyDetails" Runat="server" CommandArgument='<%# Eval("orderrent_id") %>' CommandName="OrderBuyDetails" Text="Details" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Cancel Order">
                            <HeaderStyle Font-Bold="True" />
                            <ItemTemplate>
                                <asp:Button ID="btnCancelOrderBuy" Runat="server" CommandName="CancelOrderBuy" Text="Cancel Order" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
                </asp:DataGrid>
