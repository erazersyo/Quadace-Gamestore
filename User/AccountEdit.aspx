<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AccountEdit.aspx.cs" Inherits="QuadaceGamestore.User.AccountEdit" %>
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="center">
                                ...
                                <table>
                                    <tr>
                                        <td style="width:100px;"><p>Userame:</p></td>
                                        <td><asp:TextBox class="textbox" ID="user_edit" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width:100px;"><p>Email:</p></td>
                                        <td><asp:TextBox class="textbox" ID="email_edit" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width:100px;"><p>Phone:</p></td>
                                        <td><asp:TextBox class="textbox" ID="phone_edit" runat="server"></asp:TextBox></td>
                                    </tr>
                                </table>
                                <br /><br />
                             
                            <asp:Button ID="UpdateClick" CssClass="btn_edit" runat="server" Text="Update" OnClick="UpdateButton_Click" />
                            <br />
