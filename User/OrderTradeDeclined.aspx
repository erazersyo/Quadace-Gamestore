<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderTradeDeclined.aspx.cs" Inherits="QuadaceGamestore.User.OrderTradeDeclined" %>
                        ...
                        <div class ="lefted">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="Label8" runat="server" Text="Declined"></asp:Label></td>
                                </tr>
                            </table>
