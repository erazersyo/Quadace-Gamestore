...
{
    public partial class OrderRentShipping : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        public void SetupOrderBuy()
        {
            ...
            DataSet ds = orderbuy.GetOrderRentShippingUserList(userid);
        ...
        protected void dgOrderBuy_ItemCommand(object sender, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "CancelOrderBuy")
            {
                ...
                {
                    Server.Transfer("OrderRentShipping.aspx");
                }
            }
