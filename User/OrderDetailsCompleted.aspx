<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderDetailsCompleted.aspx.cs" Inherits="QuadaceGamestore.User.OrderDetailsCompleted" %>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QuadaceGamestoreConnectionString %>" SelectCommand="SELECT * FROM [OrderBuy] WHERE ([orderbuy_id] = @orderbuy_id)">
            ...
            <asp:DataGrid ID="dgOrderBuyDetails" CssClass="datagrid" runat="server" AutoGenerateColumns="false" Width="1000px" CellPadding="10" CellSpacing="30" Height="80px">
                ...
                <div style="width:75%;text-align:right; font-family:Arial; font-size:20px;">
                    ...
                    <asp:Label ID="lbl_total_Prices" Runat="server" style="text-align:right;"></asp:Label><br />
                    <asp:Button ID="Button1" runat="server" Text="Generate Receipt" OnClick="PDF_Click" CommandArgument='<%# Eval("orderbuy_id") %>'/>
                </div>
