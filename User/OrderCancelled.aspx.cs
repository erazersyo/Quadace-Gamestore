...
{
    public partial class OrderCancelled : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        public void SetupOrderBuy()
        {
            ...
            DataSet ds = orderbuy.GetOrderBuyCancelledUserList(userid);
        ...
        protected void dgOrderBuy_ItemCommand(object sender, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "OrderBuyDetails")
            {
                ...
                Response.Redirect("OrderDetailsCancelled.aspx?id=" + e.CommandArgument.ToString());
            }
        }
