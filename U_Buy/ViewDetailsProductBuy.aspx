<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ViewDetailsProductBuy.aspx.cs" Inherits="QuadaceGamestore.U_Buy.ViewDetailsProductBuy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="justify-content:center; display:flex; flex-direction:row;">
            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" Width="1200px" OnItemCommand="DataList1_ItemCommand1">
                ...
                <div class="center-blank">
                    <div class ="left-image">
                        <br /><br />
                        <asp:Label ID="Label4" class="detail-category" runat="server" Text='<%# Bind("productbuy_category") %>'></asp:Label><br /><br />
                        <asp:Image ID="Image1" runat="server" Width="300px" Height="375px" ImageUrl='<%#"~/Images/"+Eval("productbuy_image").ToString() %>' />
                    </div>
                    <div class="right-details">
                        <br /><br />
                        <asp:Label ID="Label1" class="detail-name" runat="server" Text='<%# Bind("productbuy_name") %>'></asp:Label> <br />
                        <div class="detail-price">RM <asp:Label ID="Label2" runat="server" Text='<%# Bind("productbuy_price", "{0:n}") %>'></asp:Label></div><br />
                        <div class="detail-description">
                            <asp:Label ID="Label5" style="font-weight:bold; font-size:18px;" runat="server" Text="Description"></asp:Label><br />
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("productbuy_description") %>'></asp:Label></div><br /><br />
                        <div style="justify-content:center;">
                            <asp:Button class="btn_pm" ID="Button_minus" runat="server" Text="-" CommandName="MinusButton"/>
                            <asp:TextBox class="textbox_qty" ID="txtbox_qty" TextMode="Number" Value="1" min="1" runat="server"></asp:TextBox>
                            <asp:Button class="btn_pm" ID="Button_plus" runat="server" Text="+" CommandName="PlusButton"/>
                            <asp:Button CssClass="button_cart" ID="ButtonCart" runat="server" Text="ADD TO CART" CommandArgument='<%# Eval("productbuy_id") %>' CommandName="AddToCart"/><br /><br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QuadaceGamestoreConnectionString %>" SelectCommand="SELECT [productbuy_id], [productbuy_image], [productbuy_name], [productbuy_category], [productbuy_price], [productbuy_description] FROM [ProductBuy] WHERE ([productbuy_id] = @productbuy_id)">
            <SelectParameters>
                <asp:QueryStringParameter Name="productbuy_id" QueryStringField="id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    <div class="footer">
