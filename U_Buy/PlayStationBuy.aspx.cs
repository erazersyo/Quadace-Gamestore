...
{
    public partial class PlayStationBuy : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM ProductBuy WHERE productbuy_category = 'Play Station'", con);
        ...
        protected void DataList1_ItemCommand1(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("ViewDetailsProductBuy.aspx?id=" + e.CommandArgument.ToString());
            }
        }
