...
{
    public partial class PCGamingBuy : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM ProductBuy WHERE productbuy_category = 'PC Gaming'", con);
