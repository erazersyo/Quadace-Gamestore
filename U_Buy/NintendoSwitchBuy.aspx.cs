...
{
    public partial class NintendoSwitchBuy : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM ProductBuy WHERE productbuy_category = 'Nintendo'", con);
