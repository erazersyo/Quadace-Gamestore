<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OthersRent.aspx.cs" Inherits="QuadaceGamestore.U_Rent.OthersRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:100vh;">
        ...
        <div style="height:5vh; justify-content:center; text-align:center; display:flex; flex-direction:row;">
            ...
            <asp:Button ID="btn_others" CssClass="btn_cats" runat="server" Text="Others" OnClick="Ot_Click" />
        </div>
        <br /><br /><br />
