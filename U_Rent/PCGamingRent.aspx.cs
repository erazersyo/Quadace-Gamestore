...
{
    public partial class PCGamingRent : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM ProductRent WHERE productrent_category ='PC Gaming'", con);
