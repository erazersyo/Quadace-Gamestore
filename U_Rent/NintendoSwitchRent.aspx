<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="NintendoSwitchRent.aspx.cs" Inherits="QuadaceGamestore.U_Rent.NintendoSwitchRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:100vh;">
        ...
        <div style="height:5vh; justify-content:center; text-align:center; display:flex; flex-direction:row;">
            <asp:Button ID="btn_ns" CssClass="btn_cats" runat="server" Text="Nintendo Switch" OnClick="NS_Click" />
