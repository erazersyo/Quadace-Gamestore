...
{
    public partial class OthersRent : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void BindDataList()
        {
            ...
            con.Open();
            SqlCommand cmdImageupload = new SqlCommand("Select * FROM ProductRent WHERE productrent_category ='Others'", con);
