<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="PCGamingRent.aspx.cs" Inherits="QuadaceGamestore.U_Rent.PCGamingRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:100vh;">
        ...
        <div style="height:5vh; justify-content:center; text-align:center; display:flex; flex-direction:row;">
            ...
            <asp:Button ID="btn_pc" CssClass="btn_cats" runat="server" Text="PC Gaming" OnClick="PC_Click" />
            ...
            <asp:DataList ID="DataList1" runat="server"  Font-Size="Small" RepeatColumns="5" RepeatDirection="Horizontal" Width="1200px" OnItemCommand="DataList1_ItemCommand1" >
                ...
                <ItemTemplate>
                            <div style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                                ...
                                <div class="title">
                                    <h3 class="titles">
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("productrent_name") %>'></asp:Label>/day
                                    </h3>
                                </div>
                                <div>
                                ...
                                <div class="price">
                                    RM<asp:Label ID="Label2" runat="server" Text='<%# Bind("productrent_price", "{0:n}") %>'></asp:Label>
                                </div>
                                <br />
