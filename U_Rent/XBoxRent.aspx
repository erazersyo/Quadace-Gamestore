<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="XBoxRent.aspx.cs" Inherits="QuadaceGamestore.U_Rent.XBoxRent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:100vh;">
        ...
        <div style="height:5vh; justify-content:center; text-align:center; display:flex; flex-direction:row;">
            ...
            <asp:Button ID="btn_ps" CssClass="btn_cat" runat="server" Text="Play Station" OnClick="PS_Click" />
            <asp:Button ID="btn_xbox" CssClass="btn_cats" runat="server" Text="XBox" OnClick="Xbox_Click" />
            ...
            <asp:DataList ID="DataList1" runat="server"  Font-Size="Small" RepeatColumns="5" RepeatDirection="Horizontal" Width="1200px" OnItemCommand="DataList1_ItemCommand1" >
                ...
                <ItemTemplate>
                            <div style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                                ...
                                <div class="title">
                                    <h3 class="titles">
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("productrent_name") %>'></asp:Label>
                                    </h3>
                                </div>
                                <div>
        ...
        <div class="footer">
            ...
            <div style="margin-left:50px; margin-top:50px; color:white;">
                <asp:Label ID="Label3" runat="server" Text="© Copyright 2022 Quadace Gamestore"></asp:Label>
            </div>        
       </div>
       </div>
</asp:Content>
